...
LABEL org.label-schema.name = "stevenxie/rgv.entrypoint"
LABEL org.label-schema.url="https://rgv.stevenxie.me/"
LABEL org.label-schema.description="RGV (Reddit Graph Visualizer) Entrypoint"
...
## Configure default Caddy variables.
ENV TLS_STRATEGY="off" HOST=":80"
